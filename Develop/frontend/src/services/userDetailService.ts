...
export const getUsers = async (params?: GetUsersParams): Promise<UserDetail[]> => {
  const response = await axios.get('/api/user_detail/', { params });
...
export const getUser = async (userId: number): Promise<UserDetail> => {
  const response = await axios.get(`/api/user_detail/${userId}`);
  return response.data;
};
...
export const createUser = async (data: UserDetailCreate): Promise<UserDetail> => {
  const response = await axios.post('/api/user_detail/', data);
  return response.data;
};
...
export const updateUser = async (userId: number, data: UserDetailUpdate): Promise<UserDetail> => {
  const response = await axios.put(`/api/user_detail/${userId}`, data);
  return response.data;
};
...
export const deleteUser = async (userId: number): Promise<void> => {
  await axios.delete(`/api/user_detail/${userId}`);
};
...
export const changePassword = async (userId: number, data: PasswordChange): Promise<void> => {
  await axios.post(`/api/user_detail/${userId}/change-password`, data);
};
